...
/**
 * Test class for the MorseCodeConverterTest
...
public class MorseCodeConverterTest {
	...
	@Test
	/**
	 * Tests if class can print out all elements in tree in LNR order 
	 */
	...
	@Test
	/**
	 * Tests if class can convert morse code string to English
	 */
	...
	@Test
	/**
	 * Tests if class can convert morse code file to English
	...
	public void testConvertToEnglishFile() throws FileNotFoundException {
		...
		//Student Test
		String test3 ="this is my student test for morse code converter";		
